"""Quick desktop UI for generating Guardtower licenses."""
...
class LicenseGeneratorUI:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title('Guardtower License Generator')
    ...
    def _on_generate(self) -> None:
        ...
        messagebox.showinfo('License generated', 'License created successfully for Guardtower.')
