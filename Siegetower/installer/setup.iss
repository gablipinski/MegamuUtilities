...
;
; Prerequisites:
;   - dist\Siegetower.exe must exist (run scripts\build_exe.ps1 first)
...
[Setup]
AppId={{9A1A5B8F-0A56-4D17-AB71-87F0E2E5E2D1}}
AppName={#MyAppName}
...
OutputBaseFilename=Siegetower_Setup_{#MyAppVersion}
...
SetupIconFile={#SourcePath}\icons\siegetower.ico
...
begin
  ...
  begin
    MsgBox(
      ...
      '%APPDATA%\Siegetower\license.dat',
      mbInformation, MB_OK
    );
  end;
end;